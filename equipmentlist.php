...
if(isset($_POST["insert"]) ){
    ...
    $eqName = $_POST["eqname"];
    $eqAmount = $_POST["eqamount"];
  
  
    
   // echo $finYear." ".$yearlyInput." ".$gdpInBillions." ".$source;
	$sql = "INSERT INTO equipment_list (equipment_name,equip_amount) VALUES
            ('$eqName','$eqAmount')";
    if(mysqli_query($con, $sql)){
    	echo "Equipment List Records added successfully.";
	} else{
...
<div class="d-flex" class="wrapper">
        ...
        <!-- /#sidebar-wrapper -->
            <div class="container-fluid">
                    ...
                    <!-- Content here -->
                    <h1 class="text-center mb-5">Equipment Data Entry Form</h1>
                   
                    <form method="POST">

                        <div class="form-group row">
                            <div class="col-sm-2">   </div>
                            <label for="inputFinYear" class="col-sm-2 col-form-label">Equipment Name</label>
                            <div class="col-sm-5">
                            <input type="text" class="form-control" name="eqname" placeholder="Equipment name" required>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-2">   </div>
                            <label for="inputFinYear" class="col-sm-2 col-form-label">Equipment Amount</label>
                            <div class="col-sm-5">
                            <input type="text" class="form-control" name="eqamount" placeholder="Equipment amount" required>
                            </div>
