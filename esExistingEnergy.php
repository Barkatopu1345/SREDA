...
if(isset($_POST["insert"]) ){
   ...
   // echo $finYear." ".$yearlyInput." ".$gdpInBillions." ".$source;
	$sql = "INSERT INTO estimated_energy_data (energy_source,energy_con_per_hour,annual_operation_per_hour,annual_production) VALUES
      ...
      <div class=" bg-dark border-right" id="sidebar-wrapper">
        ...
        <!-- /#sidebar-wrapper -->
            ...
            <div class="container-fluid">
                    ...
                    <!-- Content here -->
                    <h1 class="text-center mb-5">Estimated Existing Energy Data Entry Form</h1>
                    ...
                    <div class="container-fluid mt-5">
                        ...
                        <?php
                            $sql = "SELECT * FROM estimated_energy_data"; 
