...
if(isset($_POST["insert"]) ){
   ...
   // echo $finYear." ".$yearlyInput." ".$gdpInBillions." ".$source;
	$sql = "INSERT INTO actual_energy_data (energy_source,energy_con_per_hour,annual_operation_per_hour,annual_production) VALUES
    ...
    <div class="d-flex" class="wrapper">
        ...
        <!-- /#sidebar-wrapper -->
            ...
            <div class="container-fluid">
                    ...
                    <!-- Content here -->
                    <h1 class="text-center mb-5">Actual Energy Data Entry Form</h1>
                    ...
                    <div class="container-fluid mt-5">
                        ...
                        <?php
                            $sql = "SELECT * FROM actual_energy_data"; 
